...
public class PalestranteGui extends JFrame {
    ...
    private void initComponents() {
        ...
        painelForm.add(new JLabel("URL da Foto:"), guiUtils.montarConstraints(0, 3));
        painelForm.add(tfFotoUrl, guiUtils.montarConstraints(1, 3));

        painelForm.add(new JLabel("Mini Currículo:"), guiUtils.montarConstraints(0, 4));
        ...
        if (!event.getValueIsAdjusting()) {
            ...
            if (linha >= 0) {
                ...
                if (palestrante != null) {
                    ...
                    tfFotoUrl.setText(palestrante.getFotoUrl());
