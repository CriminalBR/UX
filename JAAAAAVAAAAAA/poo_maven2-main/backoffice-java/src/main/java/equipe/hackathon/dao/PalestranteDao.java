...
public class PalestranteDao extends Dao implements DaoInterface {
    ...
    public Boolean insert(Object entity) {
        try {
            ...
            String sql = "INSERT INTO palestrantes(nome, tema, foto_url, mincurriculo) VALUES (?, ?, ?, ?)";
            ...
            ps.setString(4, palestrante.getMiniCurriculo());
    ...
    public Boolean update(Object entity) {
        try {
            Palestrante palestrante = (Palestrante) entity;
            String sql = "UPDATE palestrantes SET nome=?, tema=?, foto_url=?, mincurriculo=? WHERE id=?";
    ...
    private Palestrante mapearPalestrante(ResultSet rs) throws SQLException {
        ...
        palestrante.setFotoUrl(rs.getString("foto_url"));
        palestrante.setMiniCurriculo(rs.getString("mincurriculo"));
        return palestrante;
    }
}